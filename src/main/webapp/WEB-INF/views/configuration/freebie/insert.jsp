	                                    ...
	                                    <div id="validationform">
	                                        ...
	                                        <div class="form-group row">
	                                            ...
	                                            <div class="col-9 col-sm-7 col-lg-4">
	                                            	<label class="custom-control custom-radio custom-control-inline">
		                                                <input type="radio" value="od.or_regdate" name="fbRegType" checked="checked" class="custom-control-input"><span class="custom-control-label"> 업무페이지 등록일 </span>
		                                            </label>
	                                                <label class="custom-control custom-radio custom-control-inline">
	                                                	<input type="radio" value="od.or_settlement_day" name="fbRegType" class="custom-control-input"><span class="custom-control-label"> 결제일 </span>
		                                            </label>
	                                            </div>
	                                        </div>
	                                    </div>
	                                    ...
	                                    <div id="validationform">
	                                        ...
	                                        <div class="form-group row">
	                                            ...
	                                            <div class="col-9 col-sm-7 col-lg-4">
		                                            ...
		                                            <label class="custom-control custom-radio custom-control-inline">
		                                                <input type="radio" value="2" name="fbAddType" class="custom-control-input"><span class="custom-control-label"> 주문수량 x 개수 </span>
		                                            </label>
		                                            <label class="custom-control custom-radio custom-control-inline">
